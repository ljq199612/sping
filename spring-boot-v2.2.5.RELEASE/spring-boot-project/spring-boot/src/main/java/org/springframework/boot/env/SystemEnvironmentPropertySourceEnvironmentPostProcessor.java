 ...
 * <p>
 * SystemEnvironmentPropertySourceEnvironmentPostProcessor 类是 EnvironmentPostProcessor 接口的实现类，
 * 用来替换 Environment 环境中的 systemEnvironment，systemEnvironment 中最初存储的是 SystemEnvironmentPropertySource 类，
 * 现由实现类 OriginAwareSystemEnvironmentPropertySource 替换，OriginAwareSystemEnvironmentPropertySource 提供了
 * 获取 Origin 的方法，即返回SystemEnvironmentOrigin对象。.
 *
...
public class SystemEnvironmentPropertySourceEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
	...
	// 后置处理器的优先级， 其优先级高于 SpringApplicationJsonEnvironmentPostProcessor
